...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (url.contains("test_webview.html")) {
                    Log.d("WebView", "Test page loaded successfully - WebView is working!");
                }
            }
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                if (failingUrl.contains("file:///android_asset/build/index.html")) {
                    loadErrorPage();
                } else if (failingUrl.contains("file:///android_asset/test_webview.html")) {
                    Log.e("WebView", "Test page failed to load - WebView configuration issue");
                }
            }
        });
        ...
        // Load test page first to verify WebView works
        Log.d("MainActivity", "Loading test page to verify WebView functionality");
    ...
    private void loadErrorPage() {
        String errorHtml = "<html><head><style>" +
            ...
            "<p>WebView failed to load the application.</p>" +
